...
export const LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    chords: ['major', 'minor', 'diminished', 'augmented', 'major7', 'minor7', 'dominant7', 'half_diminished7', 'diminished7', 'sus2', 'sus4', 'add9', 'major9', 'minor9'],
    scales: ['major', 'natural_minor', 'harmonic_minor', 'melodic_minor', 'dorian', 'phrygian', 'lydian', 'mixolydian', 'locrian', 'pentatonic_major', 'pentatonic_minor', 'blues'],
    intervals: ['unison', 'minor2', 'major2', 'minor3', 'major3', 'perfect4', 'tritone', 'perfect5', 'minor6', 'major6', 'minor7', 'major7', 'octave'],
    inversions: ['root', 'first', 'second', 'third'],
    progressions: ['I-IV-V-I', 'I-V-vi-IV', 'ii-V-I', 'I-vi-IV-V', 'I-IV-vi-V', 'vi-IV-I-V', 'I-V-IV-I', 'I-bVII-IV-I'],
    features: ['Extended chords', 'Blues scale', 'Third inversions'],
  },
  {
    id: 7,
    name: 'Advanced Ear',
    description: 'Complex progressions and all content',
    icon: '👂',
    ...
    inversions: ['root', 'first', 'second', 'third'],
    progressions: ['I-IV-V-I', 'I-V-vi-IV', 'ii-V-I', 'I-vi-IV-V', 'I-IV-vi-V', 'vi-IV-I-V', 'I-V-IV-I', 'I-bVII-IV-I'],
    features: ['All chords', 'All scales', 'Advanced recognition'],
  },
  {
    id: 8,
    name: 'Master',
    ...
    inversions: ['root', 'first', 'second', 'third'],
    progressions: ['I-IV-V-I', 'I-V-vi-IV', 'ii-V-I', 'I-vi-IV-V', 'I-IV-vi-V', 'vi-IV-I-V', 'I-V-IV-I', 'I-bVII-IV-I'],
    features: ['Everything unlocked', 'Maximum difficulty', 'True mastery'],
  },
];
